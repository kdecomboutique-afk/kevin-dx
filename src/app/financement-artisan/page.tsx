...
const financementFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: [
    {
      "@type": "Question",
      name: "C'est quoi le FAFCEA exactement ?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Le FAFCEA (Fonds d'Assurance Formation des Chefs d'Entreprises Artisanales) est un organisme qui finance la formation des artisans. Si vous êtes chef d'entreprise artisanale et que vous payez la Contribution à la Formation Professionnelle (CFP), vous pouvez obtenir un financement pour vous former — y compris à la création et gestion d'un site web. Le FAFCEA prend en charge jusqu'à 80€/heure de formation, pour un maximum d'environ 4 800€ par an.",
      },
    },
    {
      "@type": "Question",
      name: "Qui est éligible au financement FAFCEA ?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Sont éligibles les chefs d'entreprise artisanale (pas les salariés) inscrits au Répertoire National des Entreprises (RNE) et à jour de leur Contribution à la Formation Professionnelle (CFP). Cela concerne les artisans du bâtiment (plombiers, électriciens, couvreurs, maçons...), de l'alimentation (boulangers, restaurateurs, traiteurs...), de la fabrication et des services. Les auto-entrepreneurs récents (moins d'un an) peuvent ne pas être éligibles car la CFP n'a pas encore été versée.",
      },
    },
    {
      "@type": "Question",
      name: "Combien est financé concrètement ?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Le FAFCEA rembourse jusqu'à 80€ par heure de formation. Pour un site vitrine (599€, incluant 14h de formation), le financement FAFCEA peut couvrir 1 120€ — soit largement plus que le coût du site. Pour un site e-commerce (1 590€, incluant 21h de formation), le financement peut atteindre 1 680€. Dans les deux cas, le reste à charge peut être de 0€.",
      },
    },
    {
      "@type": "Question",
      name: "Quelles démarches faut-il faire ?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "La démarche se fait en ligne sur le site du FAFCEA. Vous remplissez un formulaire de demande de prise en charge avant le début de la formation, en précisant le thème (création de site web / marketing digital), la durée et le coût. Une fois la formation terminée, vous envoyez les justificatifs (attestation de présence, facture) et le FAFCEA procède au remboursement sous quelques semaines.",
      },
    },
    {
      "@type": "Question",
      name: "C'est quoi Qualiopi ? C'est obligatoire ?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Qualiopi est une certification qualité pour les organismes de formation. Certains financeurs l'exigent. Pour le FAFCEA, la certification Qualiopi n'est pas toujours obligatoire mais elle facilite grandement la prise en charge.",
      },
    },
    {
      "@type": "Question",
      name: "Quelle est la différence entre FAFCEA et OPCO ?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Le FAFCEA finance les formations des chefs d'entreprise artisanale (les dirigeants). Les OPCO (Opérateurs de Compétences) financent les formations des salariés. Si vous êtes artisan à votre compte, c'est le FAFCEA qui vous concerne. Si vous avez des salariés que vous souhaitez former, c'est l'OPCO correspondant à votre branche qui interviendra.",
      },
    },
  ],
};
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(financementFaqJsonLd) }}
      />
      <FinancementHero />
      <FinancementProcess />
