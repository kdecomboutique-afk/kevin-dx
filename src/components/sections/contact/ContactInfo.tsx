...
export default function ContactInfo() {
  return (
    <div className="rounded-2xl border border-border bg-white p-6 lg:p-8">
      ...
      {/* Social links */}
      <h4 className="text-sm font-semibold text-primary">Suivez-moi</h4>
      <div className="mt-3 flex gap-3">
        {socialLinks.map((link) => (
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-lg border border-border text-text-muted transition-all duration-200 hover:border-accent hover:bg-accent hover:text-white"
          >
            {link.icon}
          </a>
        ))}
